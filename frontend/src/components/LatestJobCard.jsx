    ...
    <div className='bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-xl hover:border-gray-200 hover:-translate-y-1 transition-all duration-300 cursor-pointer group relative overflow-hidden'>
      ...
      <div className='flex items-start justify-between mb-6'>
        <div className='flex items-center gap-4'>
          ...
          <div>
            <h2 className='font-bold text-lg text-gray-900 leading-tight'>{job?.company?.name}</h2>
      ...
      <div className='flex items-center gap-2 mt-4'>
        ...
        <span className='px-4 py-1.5 rounded-full text-xs font-bold text-[#F83002] bg-[#F83002]/10 hover:bg-[#F83002]/20 transition-colors cursor-default capitalize'>
          {job?.jobType}
        </span>
